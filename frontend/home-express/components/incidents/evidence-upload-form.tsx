...
const EVIDENCE_LABELS: Record<EvidenceType, { title: string; description: string }> = {
  PICKUP_PHOTO: {
    title: "Ảnh khi lấy hàng",
    description: "Chụp ảnh hiện trạng hàng hóa tại điểm lấy hàng",
  },
  DELIVERY_PHOTO: {
    title: "Ảnh khi giao hàng",
    description: "Chụp ảnh hàng hóa sau khi giao cho khách hàng",
  },
  DAMAGE_PHOTO: {
    title: "Ảnh hư hỏng",
    description: "Chụp rõ các vị trí hư hỏng, móp méo hoặc trầy xước của hàng hóa",
  },
  SIGNATURE: {
    title: "Chữ ký xác nhận",
    description: "Ảnh hoặc tài liệu thể hiện chữ ký xác nhận của khách hàng",
  },
  INVOICE: {
    title: "Hóa đơn/chứng từ",
    description: "Ảnh hoặc file hóa đơn, chứng từ liên quan đến đơn hàng",
  },
  OTHER: {
    title: "Bằng chứng khác",
    description: "Các loại bằng chứng khác liên quan đến sự cố hoặc đơn hàng",
  },
}
