...
function getQuotationStatusBadge(status: string) {
  switch (status?.toLowerCase()) {
    case "pending":
      return { label: "Chờ duyệt", variant: "default" as const, className: "bg-blue-100 text-blue-800 hover:bg-blue-100" }
    case "negotiating":
      return { label: "Đang thương lượng", variant: "default" as const, className: "bg-orange-100 text-orange-800 hover:bg-orange-100" }
    case "accepted":
      return { label: "Đã chấp nhận", variant: "default" as const, className: "bg-green-100 text-green-800 hover:bg-green-100" }
    case "rejected":
      return { label: "Đã từ chối", variant: "destructive" as const, className: "" }
    case "expired":
      return { label: "Hết hạn", variant: "secondary" as const, className: "" }
    case "countered":
      return { label: "Đã đề xuất", variant: "default" as const, className: "bg-yellow-100 text-yellow-800 hover:bg-yellow-100" }
    case "withdrawn":
      return { label: "Đã rút", variant: "secondary" as const, className: "" }
    default:
                ...
                >
                  ...
                  <CardFooter className="flex flex-col gap-2">
                    <div className="flex gap-2 w-full">
                      {(quotation.status === "pending" || quotation.status === "negotiating") && !isExpired ? (
                        <>
                          <Button
                            variant="outline"
