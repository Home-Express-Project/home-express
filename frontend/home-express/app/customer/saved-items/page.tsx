...
function AddItemsDialog({
  ...
  return (
    ...
    >
      <DialogContent className="p-0 sm:max-w-[900px] w-[98vw] overflow-hidden">
        <section className="flex flex-col max-h-[85vh]">
          ...
          <div className="sticky bottom-0 z-10 border-t bg-background px-6 py-4 flex items-center justify-between">
                      ...
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            onClick={() =>
                              router.push(`/customer/saved-items/${item.savedItemId}`)
                            }
                          >
