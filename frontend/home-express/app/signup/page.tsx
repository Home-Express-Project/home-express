    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        >
          <SelectTrigger
            id="city"
            className={`h-14 text-base border-2 transition-all rounded-xl ${
          ...
          {currentStepKey === "role" && (
            ...
            >
              <button
                ...
                className={`role-card w-full border-2 rounded-2xl p-6 flex items-center gap-6 cursor-pointer transition-all duration-300 ${
              ...
              >
                ...
                <div
                  className={`w-7 h-7 rounded-full border-2 relative flex-shrink-0 transition-all flex items-center justify-center ${
                    selectedRole === "customer" ? "border-black bg-black" : "border-neutral-300"
                  }`}
                  aria-hidden="true"
                >
              ...
              >
                ...
                <div
                  className={`w-7 h-7 rounded-full border-2 relative flex-shrink-0 transition-all flex items-center justify-center ${
                    selectedRole === "transport" ? "border-black bg-black" : "border-neutral-300"
                  }`}
                  aria-hidden="true"
                >
                  {selectedRole === "transport" && (
                    ...
                    <div className="flex-1">
                      <div
                        className={`font-semibold text-sm mb-0.5 transition-colors ${
                          item.number <= currentStep ? "text-black" : "text-neutral-400"
                        }`}
                      >
                      ...
                      <div
                        className={`text-xs transition-colors ${
                          item.number <= currentStep ? "text-neutral-600" : "text-neutral-400"
                        }`}
                      >
