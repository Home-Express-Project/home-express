    ...
    useEffect(() => {
        ...
        const load = async () => {
            ...
            try {
                ...
                setVerificationStatus(settings.verificationStatus || "PENDING")
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-sm text-yellow-800">
                                                {verificationStatus === "PENDING"
                                                    ? "Bạn cần chờ admin xác minh tài khoản trước khi có thể nhận công việc."
                                                    : "Tài khoản của bạn đã bị từ chối. Vui lòng liên hệ support để biết thêm chi tiết."}
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
