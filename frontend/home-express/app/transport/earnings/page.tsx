    ...
    <DashboardLayout navItems={navItems} title="Thu nhập">
      <div className="max-w-7xl mx-auto space-y-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="cursor-pointer hover:shadow-md hover:border-accent-green transition-all border-2" onClick={() => router.push("/transport/earnings/settlements")}>
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-muted-foreground">Quản lý</p>
                  <p className="text-xl font-semibold mt-1">Quyết toán</p>
                  <p className="text-xs text-muted-foreground mt-2">Theo dõi trạng thái quyết toán từng đơn hàng</p>
                </div>
          ...
          <Card className="cursor-pointer hover:shadow-md hover:border-accent-green transition-all border-2" onClick={() => router.push("/transport/earnings/payouts")}>
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-muted-foreground">Quản lý</p>
                  <p className="text-xl font-semibold mt-1">Rút tiền</p>
                  <p className="text-xs text-muted-foreground mt-2">Xem lịch sử rút tiền và yêu cầu thanh toán</p>
                </div>
          ...
          <Card className="cursor-pointer hover:shadow-md hover:border-destructive transition-all border-2" onClick={() => router.push("/transport/earnings/disputes")}>
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-muted-foreground">Quản lý</p>
                  <p className="text-xl font-semibold mt-1">Tranh chấp</p>
                  <p className="text-xs text-muted-foreground mt-2">Quản lý tranh chấp và yêu cầu khiếu nại</p>
                </div>
